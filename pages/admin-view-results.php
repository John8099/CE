...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid" style="padding:20px;height:650px;overflow-y: scroll;background-color: transparent;">
                <h3>
                    <?php
                    $id = $_GET['id'];
                    $query = mysqli_query($conn, "SELECT * FROM examresults WHERE student_id = '$id' ORDER BY createAt DESC");
                    if (mysqli_num_rows($query) != 0) :
                        $student = mysqli_fetch_object(mysqli_query($conn, "SELECT * FROM students WHERE id = '$id'"));
                        echo strtoupper("$student->student_fname " . $student->student_mname[0] . ". $student->student_lname");
                    ?>
                        Exam Results
                </h3>
                <?php
                ...
                ?>
                    <div class="container" id="formContent" style="margin:20px !important">
                        <div class="row">
                            <div class="col">
                                <h3 style="padding: 20px;"><?php echo date('M d, Y h:i A', strtotime($row->createAt)) ?></h3>
                            </div>
                            <div class="col">
                ...
                <?php endwhile ?>
            <?php else : ?>
                <div class="container" id="formContent" style="margin:20px !important; padding: 20px;">
