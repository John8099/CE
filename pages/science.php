...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            <?php include '../components/admin_nav.php'; ?>
            <h5 class="" style="margin: 10px;">Science Questions</h5>
            <div class="container-fluid">
                <div class="container" style="overflow-y: scroll; height: 600px;">
                    <?php
                    $query = mysqli_query($conn, "SELECT * FROM exams WHERE category = 'science'");
                    ...
                    ?>
                        <div class="card" style="width: 20rem; height: 460px; float: left;margin:20px;">
                            <div class="bg-secondary" style="margin: 0;width: 100%;height: 30px;text-align: right;">
                                <a href="edit-exam.php?cat=Science&&id=<?php echo $row->id ?>" alt="edit" style="text-decoration: none;">
                                    <i class="fa fa-edit" style="font-size: 18px;margin: 5px"></i>
                                </a>
                                <a href="../functions/delete-exam.php?cat=science&&id=<?php echo $row->id ?>" alt="delete" class="text-danger" style="text-decoration: none;">
